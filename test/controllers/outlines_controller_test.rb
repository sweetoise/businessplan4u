...
class OutlinesControllerTest < ActionController::TestCase
  ...
  test "should create outline" do
    assert_difference('Outline.count') do
      post :create, outline: { entrepreneur_program_id: @outline.entrepreneur_program_id, question: @outline.question }
    end
  ...
  test "should update outline" do
    patch :update, id: @outline, outline: { entrepreneur_program_id: @outline.entrepreneur_program_id, question: @outline.question }
    assert_redirected_to outline_path(assigns(:outline))
  end
